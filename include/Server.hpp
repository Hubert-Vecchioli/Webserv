...
/*   Updated: 2024/10/06 16:38:50 by hvecchio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Server
{
	private:
		...
		std::vector<HttpRequest*>	_requests; // Gros defaut de cette approche: on sauvegarde toutes les requetes... Mecanisme de cleaning à ajouter?
